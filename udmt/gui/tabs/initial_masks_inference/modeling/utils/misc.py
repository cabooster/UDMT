...
def get_class_names(name):
    if name is None:
        ...
        return ["background"]
    elif 'custom_organisms_v2' in name:
        return ["celegan", "drosophila", "fish", "blackmouse", "rat", "whitemouse", "background"]
    elif 'custom_organisms' in name:
        return ["mouse", "fruit_fly", "nematode", "background"]
    else:
