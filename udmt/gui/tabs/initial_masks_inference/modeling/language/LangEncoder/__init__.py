...
def build_tokenizer(config_encoder):
    ...
    if config_encoder['TOKENIZER'] == 'clip':
        ...
        # Use local tokenizer from project directory
        current_dir = os.path.dirname(os.path.abspath(__file__))
        project_root = os.path.abspath(os.path.join(current_dir, '../../../../..'))  # Navigate to UDMT root
        tokenizer_path = os.path.join(project_root, 'pretrained', 'tokenizers','clip_tokenizer')
