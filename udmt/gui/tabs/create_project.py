...
from udmt.gui.widgets import ClickableLabel, ItemSelectionFrame
...
class ProjectCreator(QtWidgets.QDialog):
    ...
    def lay_out_user_frame(self):
        ...
        grid.addWidget(self.loc_line, 1, 1)
    ...
    def browse_videos(self):
        ...
        for video in auxiliaryfunctions.grab_files_in_folder(
            ...
            if os.path.splitext(video)[1][1:] in UDMTParams.VIDEOTYPES[1:]:
                self.video_frame.fancy_list.add_item(video)

    def finalize_project(self):
        fields = [self.proj_line] #[self.proj_line, self.exp_line]
    ...
    def update_project_location(self):
        full_name = self.name_default.format(self.proj_default)
