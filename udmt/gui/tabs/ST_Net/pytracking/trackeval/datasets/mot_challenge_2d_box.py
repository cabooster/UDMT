...
class MotChallenge2DBox(_BaseDataset):
    ...
    def __init__(self, config=None, dataset_name = None):
        ...
        self.seq_list, self.seq_lengths = self._get_seq_info(dataset_name)
    ...
    def _get_seq_info(self,dataset_name):
        seq_list = []
        seq_lengths = {}
    ...
    def _load_raw_file(self, tracker, seq, start_frame, end_frame, is_gt):
        ...
        read_data = dict(list(read_data.items())[start_frame:end_frame]) # :75
