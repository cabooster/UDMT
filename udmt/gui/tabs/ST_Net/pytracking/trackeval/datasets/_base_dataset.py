...
class _BaseDataset(ABC):
    ...
    @abstractmethod
    def _load_raw_file(self, tracker, seq,start_frame, end_frame, is_gt):
        ...
    ...
    @_timing.time
    def get_raw_seq_data(self, tracker, seq,start_frame,end_frame):
        ...
        """
        # Load raw data.
        raw_gt_data = self._load_raw_file(tracker, seq,start_frame,end_frame, is_gt=True)
        raw_tracker_data = self._load_raw_file(tracker, seq,start_frame,end_frame, is_gt=False)
