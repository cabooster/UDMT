...
class GOT10KDataset(BaseDataset):
    ...
    """
    def __init__(self, split, obj_id):
        super().__init__()
    ...
    def _construct_sequence(self, sequence_name):
        ...
        all_init_box = ground_truth_rect
        if ground_truth_rect.ndim == 1:
            ...
            if self.obj_id is None:
                ...
                try:
                    ground_truth_rect = ground_truth_rect[self.obj_id]
                except:
                    ground_truth_rect = ground_truth_rect[0]
        ...
        ## debug
        return Sequence(sequence_name, frames_list, 'got10k', ground_truth_rect.reshape(-1, 2), all_init_box)
