...
from ltr.models.tracking import dimpnet_real
...
def run(settings):
    ...
    settings.search_area_factor = 3
    settings.output_sigma_factor = 1/4
    settings.target_filter_sz = 4
    settings.feature_sz = 18
    settings.output_sz = settings.feature_sz * 16
    settings.center_jitter_factor = {'train': 1, 'test': 1}
    ...
    dataset_train = sampler.DiMPSampler([got10k_train], [1],
                                        ...
                                        processing=data_processing_train,train_num_per_sequence = 2000)
    ...
    net = dimpnet_real.dimpnet50(filter_size=settings.target_filter_sz, backbone_pretrained=True, optim_iter=5,
    ...
    loss_weight = {'iou': 0, 'test_clf': 100, 'test_init_clf': 100, 'test_iter_clf': 400}
    ...
    max_epochs = 50
    pretrained_model = '/home/bbnclxy/ext16t/lyx-star/TransformerTrack-main/pytracking/networks/pretrained/dimp50.pth'
    trainer.train(max_epochs, pretrained_model, load_latest=True, fail_safe=True)
