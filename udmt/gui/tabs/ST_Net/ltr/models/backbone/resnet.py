...
# Compatible with different versions of PyTorch and torchvision
try:
...
# Compatible with different versions of torchvision model_urls
try:
    from torchvision.models.resnet import model_urls
except ImportError:
    # Location of model_urls in newer torchvision versions
    try:
        from torchvision.models._utils import _get_model_urls
        model_urls = _get_model_urls("resnet")
    except ImportError:
        # If all imports fail, manually define model_urls
        model_urls = {
