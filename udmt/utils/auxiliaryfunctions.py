...
# from udmt.pose_estimation_tensorflow.lib.trackingutils import TRACK_METHODS
from udmt.utils import auxfun_videos
...
#
#     return os.path.split(importlib.util.find_spec("udmt").origin)[0]
